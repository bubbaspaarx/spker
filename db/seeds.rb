...
talk_types = ['Panel Expert/Moderator', 'Keynote Speaker', 'Motivational Speaker', 'Workshop Facilitator', 'After Dinner Speaker', 'Entertainer', 'Comedian', 'MC & Conference Facilitator', 'Award Host & Presenter', 'Personal Appearance']
category_topics = ['Adventure', 'Adversity', 'Arts & Culture', 'Business', 'Change', 'Customer Service', 'Design & Manufacture', 'Diversity & Equality', 'Education', 'Entertainment', 'Entrepreneurship',
  'Finance & Economics', 'Food & Drink', 'Futurist', 'Health & Wellbeing', 'HR & People Management', 'Human Rights & Philanthropy', 'Innovation', 'International Affairs',
  ...
  Technology', 'Transport & Travel', 'TV Presenter']
